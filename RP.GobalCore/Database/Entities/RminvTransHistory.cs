...
public partial class RminvTransHistory
{
    ...
    public decimal? LotQtyOrdered { get; set; }

    public decimal? LotQtyInQcinspection { get; set; }

    public decimal? LotQtyRecv { get; set; }

    public decimal? LotQtyOh { get; set; }

    public decimal? LotQtyExpired { get; set; }

    public decimal? LotQtyReserved { get; set; }

    public decimal? LotQtyAllocated { get; set; }
}
