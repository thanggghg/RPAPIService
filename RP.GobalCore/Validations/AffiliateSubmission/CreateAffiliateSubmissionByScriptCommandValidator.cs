...
{
    public class CreateAffiliateSubmissionByScriptCommandValidator : AbstractValidator<CreateAffiliateSubmissionByScriptCommand>
    {
        public CreateAffiliateSubmissionByScriptCommandValidator()
        {
            ...
            RuleFor(command => command.GroupId).Must(x => !string.IsNullOrEmpty(x)).WithErrorCode(nameof(SubmissionCodeEnum.INVALID_GROUP_ID));
