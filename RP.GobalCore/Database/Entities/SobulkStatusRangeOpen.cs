...
public partial class SobulkStatusRangeOpen
{
    ...
    public string BomWusched { get; set; }

    public string WuschedWu { get; set; }

    public int? WuBlend { get; set; }

    public int? BlendEncap { get; set; }

    public int? EncapCoat { get; set; }

    public int? ToInspect { get; set; }

    public int? InspectRelease { get; set; }
