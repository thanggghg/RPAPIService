...
{
    public class GetAllAffiliateStoreByGsIdQueryHandler : IRequestHandler<GetAllAffiliateStoreByGsIdQuery, List<AffiliateStoreViewModel>>
    {
        ...
        public GetAllAffiliateStoreByGsIdQueryHandler(ILogger<GetAllAffiliateStoreQueryHandler> logger,
                                           IMapper mapper,
        ...
        public async Task<List<AffiliateStoreViewModel>> Handle(GetAllAffiliateStoreByGsIdQuery request, CancellationToken cancellationToken)
        {
            try
            {
