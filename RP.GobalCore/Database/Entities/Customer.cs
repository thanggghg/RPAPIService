...
public partial class Customer
{
    ...
    public string TempCsrep { get; set; }

    public DateOnly? TempCsrepExpFromDt { get; set; }

    public DateOnly? TempCsrepExpToDt { get; set; }

    public virtual ICollection<CustomerLogBookHeader> CustomerLogBookHeaders { get; set; } = new List<CustomerLogBookHeader>();
