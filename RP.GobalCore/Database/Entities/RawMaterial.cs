...
public partial class RawMaterial
{
    ...
    public virtual ICollection<RmcleanLabel> RmcleanLabels { get; set; } = new List<RmcleanLabel>();

    public virtual ICollection<Rmmanufacture> Rmmanufactures { get; set; } = new List<Rmmanufacture>();

    public virtual ICollection<RmtestResult> RmtestResults { get; set; } = new List<RmtestResult>();
}
