...
namespace GoSell.Affiliate.Tracking.Migrations
{
    ...
    [Migration("20240904043243_affiliate_store_currency")]
    partial class affiliate_store_currency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("affiliate_store_currency_id_seq", "affiliate-tracking-services");
            ...
            modelBuilder.Entity("GoSell.Affiliate.Tracking.Database.Entities.AffiliateStore", b =>
                {
                    ...
                    b.Property<long?>("AffiliateStoreCurrencyId")
                        .HasColumnType("bigint")
                        .HasColumnName("affiliate_store_currency_id");
                    ...
                    b.HasIndex("AffiliateStoreCurrencyId");
            ...
            modelBuilder.Entity("GoSell.Affiliate.Tracking.Database.Entities.AffiliateStoreCurrency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("id")
                        .HasDefaultValueSql("nextval('\"affiliate-tracking-services\".affiliate_store_currency_id_seq')");

                    NpgsqlPropertyBuilderExtensions.UseSequence(b.Property<long>("Id"), "affiliate_store_currency_id_seq", "affiliate-tracking-services");
                    ...
                    b.ToTable("affiliate_store_currency", "affiliate-tracking-services");
                });
            ...
            modelBuilder.Entity("GoSell.Affiliate.Tracking.Database.Entities.AffiliateStore", b =>
                {
                    b.HasOne("GoSell.Affiliate.Tracking.Database.Entities.AffiliateStoreCurrency", "AffiliateStoreCurrency")
                        .WithMany("AffiliateStores")
                        .HasForeignKey("AffiliateStoreCurrencyId");
                    ...
                    b.Navigation("AffiliateStoreCurrency");
                });
