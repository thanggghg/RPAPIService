...
public partial class Zmm860Hdr
{
    public int HdrPk { get; set; }

    public string Partner { get; set; }

    public string Bch03PoNumber { get; set; }

    public DateTime? Hdr860Processed { get; set; }

    public string Bch01HdrPoPurposeCode { get; set; }

    public string Bch02HdrPoTypeCd { get; set; }

    public string Bch04ReleaseNumber { get; set; }

    public string Bch05ChangeSeq { get; set; }

    public DateTime? Bch06Date { get; set; }

    public string Bch07ReqRefNo { get; set; }

    public string Bch08ContractNumber { get; set; }

    public string Bch09RefId { get; set; }

    public DateTime? Bch10Date { get; set; }

    public DateTime? Bch11Date { get; set; }
